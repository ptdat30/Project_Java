...
public class DailyProgressResponse {
    ...
    public DailyProgressResponse(DailyProgress entity) {
        this.date = entity.getDate();
        this.mood = entity.getMoodRating();
        this.cravings = entity.getCravingsIntensity();
        this.exercise = entity.getExercise();
        this.water = entity.getWater();
        this.sleep = entity.getSleep();
        this.note = entity.getNote();
        this.smokedToday = entity.getSmokedToday();
        this.cigarettesToday = entity.getCigarettesToday();
        this.moneySpentToday = entity.getMoneySpentToday();
    }
    ...
    public static DailyProgressResponse fromEntity(DailyProgress entity) {
        return new DailyProgressResponse(entity);
    }
} 